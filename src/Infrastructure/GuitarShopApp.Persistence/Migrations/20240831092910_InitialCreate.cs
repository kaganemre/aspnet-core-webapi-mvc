...
namespace GuitarShopApp.Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "EmailConfirmed", "FullName", "Password", "RoleName" },
                values: new object[,]
                {
                    { 1, "info@adminuser.com", true, "Admin", "Password_536", "admin" },
                    { 2, "info@paulgilbert.com", true, "Paul Gilbert", "Paul_536", "" }
                });
